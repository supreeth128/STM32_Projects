...
sys/src/%.o: ../sys/src/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra  -g -x assembler-with-cpp -DNDEBUG -DSTM32F407xx -I"/home/super/Desktop/STM32_Projects/0_OUTPUT/inc" -I"/home/super/Desktop/STM32_Projects/0_OUTPUT/sys/cmsis/inc" -I"/home/super/Desktop/STM32_Projects/0_OUTPUT/sys/inc" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
